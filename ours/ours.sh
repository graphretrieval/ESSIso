...
do
    ...
    do
        ...
        do
            ...
            ./out -t ${tout} -e 100 -c -s 50 -h -k 1 -d -b ${datadir}/d.dimas ${datadir}/query${i}_weighted/  > ${savedir}/exp7_ours_${dataset}_nnode${graph_size}_fam50_rate10_case20_len1000_randomFalse_set${i}_tout${tout}.txt
        done
    done
done
